...
export default function App() {
  ...
  return (
    <div>
      ...
      <ModalComponent visible={modal} onCancel={() => setModal(false)}>
        <h2 style={{ color: "#fff", fontSize: "24px" }}>
          Alert! <WarningOutlined style={{ color: "yellow" }} />
        </h2>
        <p>
          You are connect to another network, Please switch to Binance Smart
